...
const motion_card_grid = document.querySelector(
  ".landing_page_motion_card_grid"
);
...
form.querySelector("#motion_description").value =
  "A quick description of the motion";
...
let id = data.motion_list.length
